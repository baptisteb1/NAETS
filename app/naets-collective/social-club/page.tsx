...
export const metadata: Metadata = {
  title: 'Social Club — NÆTS Collective',
  description:
    'Le NÆTS Social Club : la communauté au-delà de la course. Rencontres, échanges, univers NÆTS.',
};
    ...
    <main>
      <section className="relative min-h-[68vh] flex flex-col justify-end bg-[#0A0A0A] overflow-hidden">
        ...
        <div className="absolute top-12 left-8 md:left-16">
          <p className="font-naets-micro text-white/30">NÆTS COLLECTIVE — SOCIAL CLUB</p>
        </div>

        <div className="relative z-10 px-8 md:px-16 pb-20 md:pb-28 max-w-screen-xl mx-auto w-full">
          <p className="font-naets-micro text-white/25 mb-4">02 — COMMUNAUTÉ</p>
          <h1
            className="font-condensed text-white leading-none mb-5"
            style={{
              fontFamily: "'Bebas Neue', sans-serif",
              fontSize: 'clamp(62px, 10.5vw, 152px)',
          ...
          >
            Au-delà de la course. L&apos;univers NÆTS, les rencontres, la communauté.
          </p>
          <Link
        ...
        <div className="max-w-screen-xl mx-auto">
          <div className="flex items-start gap-5">
            ...
            <div>
              ...
              >
                Le NÆTS Social Club sera lancé avec le premier drop. Rejoignez la communauté via{' '}
