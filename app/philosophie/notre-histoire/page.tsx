...
export const metadata: Metadata = {
  ...
  description:
    'L\'histoire de NÆTS : de la conviction à la chaussure. Une marque née pour les coureurs qui ne cherchent pas à se montrer.',
};
    ...
    <main>
      ...
      <section className="relative min-h-[68vh] flex flex-col justify-end bg-[#0A0A0A] overflow-hidden">
        ...
        <div className="absolute top-12 left-8 md:left-16">
          <p className="font-naets-micro text-white/30">PHILOSOPHIE — NOTRE HISTOIRE</p>
        </div>

        <div className="relative z-10 px-8 md:px-16 pb-20 md:pb-28 max-w-screen-xl mx-auto w-full">
          <p className="font-naets-micro text-white/25 mb-4">01 — MARQUE</p>
          <h1
          ...
          >
            De la conviction à la chaussure. L&apos;histoire de NÆTS commence ici.
          </p>
          <Link
            href="/philosophie"
        ...
        <div className="max-w-screen-xl mx-auto">
          <div className="flex items-start gap-5">
            ...
            <div>
              ...
              >
                L&apos;histoire complète de NÆTS arrive prochainement. Retrouvez en attendant notre
                vision sur la page{' '}
                <Link href="/philosophie" className="text-black hover:underline">
                  Philosophie
                </Link>
                .
              </p>
